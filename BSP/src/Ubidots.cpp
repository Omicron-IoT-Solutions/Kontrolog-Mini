...
String Ubi_token=  "BBUS-8j0Cs07GBsCUCvwI8aE5f2iH7eBgcs";                                      // Your Ubitoken
...
// Inputs  String with Data to send

// Result:
  - 1 : Error Not server found
    xx : httpCode Error Code
    200:  Correct
...
// Result:
  ...
  // ------------------------------
  */
String ubidots_class::downlink_data(void)
{
    String URL_Downlink;
    String rx_line="";
...
//---------------------------------------------------------------------------------------------------------------------
//  ---- CONSULTA Y MODIFICACIÓN DE Data Y PARAMETROS AL DISPOSTIVO E INTEFACES DE SENSORES POR PUERTO SERIAL ----

// Función: 
// Consulta modificación Data al dispositivo y espera por respuesta

 // Entradas  int Caso + String Data
/* com_module   == Pregunta por los parámetros básicos del módulo de comunicación Tipo  + ID   -- Data = ""
   set_time,    == Para establecer tiempo --- Data :  Estampa de tiempo en hexadecimal
   error_wifi,  == Indica que el módulo WiFi no pudo entregar dato y generó error  ---  Data = ""
   parametro    == Envio de un parámetro general al Disipositivo ---  Data= Información del paráemtro 16 Bytes hexadecimal
*/

//---------------------------------------------------------------------------------------------------------------------

char ubidots_class::Consulta_Mod_Data(int Caso, String Data)
{
...
// Converting Strin Hex to Decimal:
...
{   
     float input = hexToDec(hexString);           // The variables are stored in 12 Bits
